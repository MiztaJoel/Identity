...
using System.Text;
using static Identity.Controllers.IdentityUserEndpoints;
	...
	public static class IdentityUserEndpoints
	{
														...
														[FromBody] UserRegistrationModel userRegistrationModel)
		{
			AppUser user = new AppUser()
			{
				...
				Library=userRegistrationModel.LibraryID,
			};
										...
										[FromBody] LoginModel loginModel,IOptions<AppSettings> appsettings )
		{
			...
			if (user != null && await userManager.CheckPasswordAsync(user, loginModel.Password))
			{
				...
				if (user.Library != null)
					claims.AddClaim(new Claim("LibaryID", user.Library.ToString()!));
